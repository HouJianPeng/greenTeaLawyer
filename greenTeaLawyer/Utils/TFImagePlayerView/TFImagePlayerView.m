...
@interface TFImagePlayerView() <UIScrollViewDelegate>
...
@property (nonatomic, strong) UIImageView *pageBackGroundView;
@end

@implementation TFImagePlayerView
...
- (void)_init
{
    ...
    // pageBGView
    self.pageBackGroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Home_BGView"]];
...
- (void)reloadData
{
    ...
    // 背景
    CGFloat pageBGHeight = width / (640 / 102);
    self.pageBackGroundView.frame = CGRectMake(0, height - pageBGHeight, width, pageBGHeight);
}
