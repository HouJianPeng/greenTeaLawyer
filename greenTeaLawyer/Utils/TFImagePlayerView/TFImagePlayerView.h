...
@interface TFImagePlayerView : UIView
 ...
 *  @param index           index of imageview
 */
- (void)imagePlayerView:(TFImagePlayerView *)imagePlayerView didTapAtIndex:(NSInteger)index;
 ...
 */
- (void)imagePlayerView:(TFImagePlayerView *)imagePlayerView didTapAtIndex:(NSInteger)index imageURL:(NSURL *)imageURL DEPRECATED_ATTRIBUTE;
@end
