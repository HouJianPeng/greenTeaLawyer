...
#define ApplyCaseListURL             @"http://www.lawcheck.com.cn/cosmos.json?command=scommerce.LC_CASE_LAWCASE_LIST_BLOCK"    // 律师接案列表

#define CaseDetailURL                @"http://www.lawcheck.com.cn/cosmos.json?command=scommerce.LC_CASE_LAWCASE_GET_BLOCK"     // 案件详情

#define PickUpCaseYesOrNOURL         @"http://www.lawcheck.com.cn/cosmos.json?command=scommerce.LC_CASE_LAWCASE_VERIFY_ACTION" // 校验律师是否可以接案

#define ApplyCaseURL                 @"http://www.lawcheck.com.cn/cosmos.json?command=scommerce.LC_CASE_LAWYERCASE_SAVE_ACTION"            // 律师接案
