...
+ (CaseModel *)caseModelWithDict:(NSDictionary *)dict
{
    ...
    caseModel.price = [ValueUtils stringFromObject:[dict objectForKey:@"price"]];
    caseModel.reply = [ValueUtils stringFromObject:[dict objectForKey:@"reply"]];
    caseModel.cycleTime = [ValueUtils stringFromObject:[dict objectForKey:@"cycleTime"]];
